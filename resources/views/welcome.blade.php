                    ...
                    <div class="d-flex flex-column flex-column-fluid mb-5 mb-lg-10">
                        ...
                        <div class="d-flex flex-center pt-10 pt-lg-0 mb-10 mb-lg-0 h-lg-225px">
                            ...
                            <a href="../../demo10/dist/index.html">
                                <img alt="Logo" src="{{ asset('public/assets/media/logos/default-small.svg') }}"
                                    class="h-70px" />
                            </a>
                            <!--end::Logo-->
                        </div>
                                ...
                                <div class="card border-0 shadow-none h-lg-100" style="background-color: #A838FF">
                                    ...
                                    <div class="card-body d-flex flex-column flex-center pb-0 pt-15">
                                        ...
                                        <div class="px-10 mb-10">
                                            <!--begin::Heading-->
                                            <h3 class="text-white mb-2 fw-bolder ttext-center text-uppercase mb-6">Sell
                                                On Metronic</h3>
                                            <!--end::Heading-->
                                            <!--begin::List-->
                                            <div class="mb-7">
                                                ...
                                                <div class="d-flex align-items-center mb-2">
                                                    <i
                                                        class="ki-duotone ki-black-right fs-4 text-white opacity-75 me-3"></i>
                                            ...
                                            <a href="../../demo10/dist/dashboard.html"
                                                class="btn btn-hover-rise text-white bg-white bg-opacity-10 text-uppercase fs-7 fw-bold">Go
                                                To Dashboard</a>
                                            <!--end::Link-->
                                        </div>
                                        <!--end::Wrapper-->
                                        ...
                                        <img class="mw-100 h-225px mx-auto mb-lg-n18"
                                            src="{{ asset('public/assets/media/illustrations/sigma-1/12.png') }}" />
                                        <!--end::Illustrations-->
                                    </div>
                                    <!--end::Card body-->
                                </div>
                                        ...
                                        <a href="#" data-bs-toggle="modal"
                                            ...
                                            <div class="card-body d-flex flex-column flex-center text-center">
                                                ...
                                                <img class="mw-100 h-100px mb-7 mx-auto"
                                                    src="{{ asset('public/assets/media/illustrations/sigma-1/4.png') }}" />
                                                <!--end::Illustrations-->
                                                <!--begin::Heading-->
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <a href="#" data-bs-toggle="modal"
                                            ...
                                            <div class="card-body d-flex flex-column flex-center text-center">
                                                <!--begin::Illustrations-->
                                                <img class="mw-100 h-100px mb-7 mx-auto"
                                                    src="{{ asset('public/assets/media/illustrations/sigma-1/5.png') }}" />
                                                <!--end::Illustrations-->
                                                <!--begin::Heading-->
                                ...
                                <div class="card border-0 shadow-none min-h-200px" style="background-color: #D5D83D">
                                    ...
                                    <div class="card-body d-flex flex-center flex-wrap">
                                        ...
                                        <img class="mw-100 h-200px me-4 mb-5 mb-lg-0"
                                            src="{{ asset('public/assets/media/illustrations/sigma-1/11.png') }}" />
                                        <!--end::Illustrations-->
                                        <!--begin::Wrapper-->
                        ...
                        <ul class="menu fw-semibold order-1">
                            <li class="menu-item">
                                <a href="https://keenthemes.com" target="_blank"
                                    class="menu-link text-white opacity-50 opacity-100-hover px-3">About</a>
                            </li>
                            <li class="menu-item">
                            ...
                            <li class="menu-item">
                                <a href="https://devs.keenthemes.com" target="_blank"
                                    class="menu-link text-white opacity-50 opacity-100-hover px-3">Support</a>
                            </li>
                            <li class="menu-item">
                                <a href="https://1.envato.market/EA4JP" target="_blank"
                                    class="menu-link text-white opacity-50 opacity-100-hover px-3">Purchase</a>
                            </li>
                        </ul>
                        <!--end::Navs-->
                    </div> --}}
            ...
            {{-- <div id="kt_sidebar" class="sidebar px-5 py-5 py-lg-8 px-lg-11" data-kt-drawer="true"
                        ...
                        <div class="timeline">
                            ...
                            <div class="timeline-item">
                                ...
                                <div class="timeline-content mb-10 mt-n1">
                                    ...
                                    <div class="pe-3 mb-5">
                                        <!--begin::Title-->
                                        <div class="fs-5 fw-semibold mb-2 text-white">Created 2 new tasks in
                                            "Development"</div>
                                        <!--end::Title-->
                                        <!--begin::Description-->
                                    ...
                                    <div class="pb-5">
                                        ...
                                        <div class="d-flex flex-stack border rounded px-7 py-3">
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="fs-5 text-white text-hover-success fw-semibold w-375px">Meeting
                                                with customer</a>
                                            <!--end::Title-->
                                            <!--begin::Action-->
                                            <a href="#"
                                                class="btn btn-sm btn-hover-rise text-white bg-white bg-opacity-10">View</a>
                                            <!--end::Action-->
                                        </div>
                                        <!--end::Record-->
                                    </div>
                            ...
                            <div class="timeline-item">
                                ...
                                <div class="timeline-content mb-10 mt-n2">
                                    ...
                                    <div class="pe-3">
                                        <!--begin::Title-->
                                        <div class="fs-5 text-white fw-semibold mb-2">2 new entries in "Landing Page"
                                        </div>
                                        <!--end::Title-->
                                        <!--begin::Description-->
                                        <div class="d-flex align-items-center mt-1 fs-6">
                            ...
                            <div class="timeline-item">
                                ...
                                <div class="timeline-content mb-10 mt-n1">
                                    ...
                                    <div class="mb-5 pe-3">
                                        <!--begin::Title-->
                                        <a href="#"
                                            class="fs-5 fw-semibold text-white text-hover-success mb-2">3 New Incoming
                                            Project Files</a>
                                        <!--end::Title-->
                                        <!--begin::Description-->
                                        <div class="d-flex align-items-center mt-1 fs-6">
                                            ...
                                            <div class="d-flex align-items-center me-2">
                                                ...
                                                <div class="d-flex flex-stack">
                                                    ...
                                                    <div class="d-flex flex-column me-2">
                                                        <!--begin::Desc-->
                                                        <a href="#"
                                                            class="fs-7 text-white text-hover-success fw-bold">App
                                                            Guidelines</a>
                                                        <!--end::Desc-->
                                                        <!--begin::Number-->
                                            ...
                                            <div class="d-flex align-items-center me-2">
                                                ...
                                                <div class="d-flex flex-stack">
                                                    ...
                                                    <div class="d-flex flex-column me-2">
                                                        <!--begin::Desc-->
                                                        <a href="#"
                                                            class="fs-7 text-white text-hover-success fw-bold">Reports</a>
                                                        <!--end::Desc-->
                                                        <!--begin::Number-->
                                ...
                                <div class="timeline-content mb-10 mt-n2">
                                    ...
                                    <div class="pe-3">
                                        ...
                                        <div class="fs-5 text-white fw-semibold mb-2">
                                            <a href="#" class="text-success">KTApp.js</a>&nbsp;has new merged
                                            into Master
                                        </div>
                                        <!--end::Title-->
                                        <!--begin::Description-->
                            ...
                            <div class="timeline-item">
                                ...
                                <div class="timeline-content mb-10 mt-n2">
                                    ...
                                    <div class="pe-3">
                                        <!--begin::Title-->
                                        <div class="fs-5 text-white fw-semibold mb-2">2 new notifications received
                                        </div>
                                        <!--end::Title-->
                                        <!--begin::Description-->
                                        <div class="d-flex align-items-center mt-1 fs-6">
                            ...
                            <div class="timeline-item">
                                ...
                                <div class="timeline-content mb-10 mt-n1">
                                    ...
                                    <div class="mb-5 pe-3">
                                        <!--begin::Title-->
                                        <a href="#"
                                            class="fs-5 fw-semibold text-white text-hover-success mb-2">You have
                                            received a payment</a>
                                        <!--end::Title-->
                                        <!--begin::Description-->
                                        <div class="d-flex align-items-center mt-1 fs-6">
                                            <!--begin::Info-->
                                            ...
                                            <div class="d-flex align-items-center me-2">
                                                ...
                                                <div class="d-flex flex-stack">
                                                    ...
                                                    <div class="d-flex flex-column me-2">
                                                        <!--begin::Desc-->
                                                        <a href="#"
                                                            class="fs-7 text-white text-hover-success fw-bold">Withdrawing
                                                            Funds</a>
                                                        <!--end::Desc-->
                                                        <!--begin::Number-->
                ...
                <div class="text-center" id="kt_sidebar_footer">
                    ...
                    <a href="../../demo10/dist/pages/user-profile/activity.html"
                        class="btn btn-hover-rise text-white bg-white bg-opacity-10 text-uppercase fs-7 fw-bold">View
                        Updates</a>
                    <!--end::Link-->
                </div>
                <!--end::Footer-->
                                ...
                                <div data-kt-stepper-element="content">
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="text-center px-4">
                                            <img src="{{ asset('public/assets/media/illustrations/sigma-1/9.png') }}"
                                    ...
                                    <div class="d-flex flex-column mb-7 fv-row">
                                        ...
                                        <div class="position-relative">
                                            ...
                                            <div class="position-absolute translate-middle-y top-50 end-0 me-5">
                                                <img src="{{ asset('public/assets/media/svg/card-logos/visa.svg') }}"
                                                    alt="" class="h-25px" />
                                                <img src="{{ asset('public/assets/media/svg/card-logos/mastercard.svg') }}"
                                                    alt="" class="h-25px" />
                                                <img src="{{ asset('public/assets/media/svg/card-logos/american-express.svg') }}"
                                                    alt="" class="h-25px" />
                                            </div>
                                            <!--end::Card logos-->
                                        </div>
                                ...
                                <div class="w-100">
                                    ...
                                    <div class="pb-8 pb-lg-10">
                                        ...
                                        <div class="text-muted fw-semibold fs-6">If you need more info, please
                                            <a href="../../demo10/dist/.html" class="link-primary fw-bold">Sign
                                                In</a>.
                                        </div>
                                        <!--end::Notice-->
                                    </div>
