...
<head>
    ...
    <meta property="og:title"
        content="SIGEMA 45" />
    <meta property="og:url" content="https://sisenep.com/queensi2020/login" />
    <meta property="og:site_name" content="Login | SIGEMA 45" />
                    ...
                    <div class="w-lg-500px p-10">
                        ...
                        <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form"
                            ...
                            {{-- <div class="d-flex flex-stack flex-wrap gap-3 fs-base fw-semibold mb-8">
                                <div></div>
                                <!--begin::Link-->
                                <a href="../../demo10/dist/authentication/layouts/corporate/reset-password.html"
