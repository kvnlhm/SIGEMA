...
@section('breadcrumb')
    <div class="page-title d-flex flex-column me-5 py-2">
        ...
        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
            ...
            <li class="breadcrumb-item text-muted">
                <a href="{{ url('clustering/inisialisasi/'.encrypt($kelompok->id_pengelompokan)) }}" class="text-muted text-hover-primary">Langkah 1</a>
            </li>
            <li class="breadcrumb-item">
                <span class="bullet bg-gray-200 w-5px h-2px"></span>
            </li>
            <li class="breadcrumb-item text-dark">Langkah 2</li> --}}
            <li class="breadcrumb-item text-dark">Inisialisasi Update</li>
        </ul>
    </div>
@endsection
        ...
        <div class="card-body">
            <div class="stepper stepper-links d-flex flex-column pt-15" id="kt_create_account_stepper">
                ...
                <form class="mx-auto mw-600px w-100 pt-15 pb-10" id="kt_create_account_form"
                    action="{{ route('clustering.process-upload2') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="id_kelompok" value="{{ encrypt($kelompok->id_pengelompokan) }}">
                        ...
                        <div class="w-100">
                            <div class="pb-10 pb-lg-12">
                                ...
                                <div class="text-muted fw-semibold fs-6">Jika Anda memerlukan info lebih lanjut, silakan
                                    ...
                                    @if (Auth::user()->id_priv != 1)
                                        <br>
                                        <span class="text-danger">Dan untuk pengguna hanya bisa menginputkan file excel saja.</span>
                                    @endif
                                </div>
                            </div>
                            {{-- <div class="fv-row mb-10">
                                ...
                                <input name="judul" class="form-control form-control-lg form-control-solid"
                                    placeholder="Masukkan judul pengelompokan" required value="{{ $kelompok->judul }}" @if(Auth::user()->id_priv != 1) readonly @endif />
                            ...
                            <div class="fv-row mb-10">
                                ...
                                <select name="periode" class="form-select form-select-lg form-select-solid"
                                    ...
                                    <option></option>
                                    <option value="2024-2025" {{ $kelompok->periode == '2024-2025' ? 'selected' : '' }}>2024-2025</option>
                                    <option value="2023-2024" {{ $kelompok->periode == '2023-2024' ? 'selected' : '' }}>2023-2024</option>
                                    <option value="2022-2023" {{ $kelompok->periode == '2022-2023' ? 'selected' : '' }}>2022-2023</option>
                                    <option value="2021-2022" {{ $kelompok->periode == '2021-2022' ? 'selected' : '' }}>2021-2022</option>
                                    <option value="2020-2021" {{ $kelompok->periode == '2020-2021' ? 'selected' : '' }}>2020-2021</option>
                                    <option value="2019-2020" {{ $kelompok->periode == '2019-2020' ? 'selected' : '' }}>2019-2020</option>
                                    <option value="2018-2019" {{ $kelompok->periode == '2018-2019' ? 'selected' : '' }}>2018-2019</option>
                                    <option value="2017-2018" {{ $kelompok->periode == '2017-2018' ? 'selected' : '' }}>2017-2018</option>
                                    <option value="2016-2017" {{ $kelompok->periode == '2016-2017' ? 'selected' : '' }}>2016-2017</option>
                                    <option value="2015-2016" {{ $kelompok->periode == '2015-2016' ? 'selected' : '' }}>2015-2016</option>
                                    <option value="2014-2015" {{ $kelompok->periode == '2014-2015' ? 'selected' : '' }}>2014-2015</option>
                                    <option value="2013-2014" {{ $kelompok->periode == '2013-2014' ? 'selected' : '' }}>2013-2014</option>
                                    <option value="2012-2013" {{ $kelompok->periode == '2012-2013' ? 'selected' : '' }}>2012-2013</option>
                                    <option value="2011-2012" {{ $kelompok->periode == '2011-2012' ? 'selected' : '' }}>2011-2012</option>
                                    <option value="2010-2011" {{ $kelompok->periode == '2010-2011' ? 'selected' : '' }}>2010-2011</option>
                                </select>
                            </div> --}}
                            <div class="fv-row mb-10">
                            ...
                            {{-- <div class="fv-row mb-10">
                                ...
                                @php
                                    // Ambil nilai dari $kelompok->conditions dan hilangkan tanda kurung siku
                                    $conditions = str_replace(['[', ']', '"'], '', $kelompok->conditions);
                                ...
                                <div id="conditionInputs">
                                    @foreach($conditionsArray as $condition)
                                        <div class="input-group mb-3">
                                            <input type="text" name="conditions[]" class="form-control" placeholder="Contoh: 80-90=0.5" value="{{ $condition }}">
                            ...
                            <div class="fv-row mb-10">
                                ...
                                <input type="number" name="jumlah_cluster"
                                    ...
                                    placeholder="Masukkan jumlah cluster" required value="{{ $kelompok->jumlah_cluster }}" @if(Auth::user()->id_priv != 1) readonly @endif />
                            </div>
                            {{-- <div class="fv-row mb-10">
                                ...
                                <input type="number" name="pembobot"
                                    ...
                                    step="any" required value="{{ $kelompok->pembobot }}" @if(Auth::user()->id_priv != 1) readonly @endif />
                            </div>
                            <div class="fv-row mb-10">
                                <label class="fs-6 fw-semibold form-label required">Nilai error (e)</label>
                                <input type="number" name="nilai_error" step="any"
                                    class="form-control form-control-lg form-control-solid"
                                    placeholder="Masukkan nilai error seperti 0.01" required value="{{ $kelompok->nilai_error }}" @if(Auth::user()->id_priv != 1) readonly @endif />
                            </div>
                            <div class="fv-row mb-10">
                                <label class="fs-6 fw-semibold form-label required">Maksimal Iterasi (maxiter)</label>
                                <input type="number" name="maksimal_iterasi"
                                    class="form-control form-control-lg form-control-solid"
                                    placeholder="Masukkan maksimal iterasi" required value="{{ $kelompok->maksimal_iterasi }}" @if(Auth::user()->id_priv != 1) readonly @endif />
                            </div> --}}
                        </div>
                    </div>
                    <div class="d-flex flex-stack pt-15">
                        {{-- <div class="mr-2">
                            <a href="{{ url('clustering/inisialisasi/'.encrypt($kelompok->id_pengelompokan)) }}" class="btn btn-lg btn-light-primary me-3">
