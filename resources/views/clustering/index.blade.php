                ...
                <form class="mx-auto mw-600px w-100 pt-15 pb-10" novalidate="novalidate" id="kt_create_account_form">
                    <div class="current" data-kt-stepper-element="content">
                        <div class="w-100">
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <div class="form-text">Inputkan jumlah data terlebih dahulu sebelum mendownload file excel</div>
                            </div>
                            <button type="button" class="btn btn-sm btn-light-success" id="downloadButton" onclick="downloadExcel()" disabled>
                    ...
                    <div class="d-flex flex-stack pt-15">
                        ...
                        <div>
                            ...
                            <a href="{{ url('clustering2') }}" class="btn btn-lg btn-primary"
                                >Berikutnya
